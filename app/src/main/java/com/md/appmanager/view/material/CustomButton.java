package com.md.appmanager.view.material;
...
public abstract class CustomButton extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(UtilsTools.Tools.dpToPx(minHeight, getResources()));
		setMinimumWidth(UtilsTools.Tools.dpToPx(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - UtilsTools.Tools.dpToPx(6, getResources()), getHeight()
						- UtilsTools.Tools.dpToPx(7, getResources()), Config.ARGB_8888);
